...
var PROJECTS = [
  {
    ...
    downloads: {
      windows: [
        { name: "Setup (EXE)", url: "#", size: "2.56 MB", sha256: "b4c69401c241bcacd8923b33e9036916b8eabc1ca64d15b42307efc1505d8aa7" },
        { name: "Installer (MSI)", url: "#", size: "3.92 MB", sha256: "f8cf27babb00ef1a80b58d2cb26e76ea8d86e81e9baa3b86b7080cc40c946d1e" }
      ],
      mac: [
        { name: "Universal DMG", url: "#", size: "7.98 MB", sha256: "a0d40169bf3fe2a8148e441fa634395cc6f8ea636a93004271344f7e8f9660c5" },
        { name: "App Bundle (tar.gz)", url: "#", size: "7.91 MB", sha256: "ba9e282b004468a5521d1b2fc8af4e39156bdd6187f95cca62885b805cd7b0e0" }
      ],
      linux: [
        { name: "Debian/Ubuntu (.deb)", url: "#", size: "4.1 MB", sha256: "6fba19ac3fdb5ec2c0555146a5411badbb3c1fbfff4c586c5cc92098a39593c4" },
        { name: "Fedora/RHEL (.rpm)", url: "#", size: "4.1 MB", sha256: "7769fcfdf3cd7648a5051322abc911da7152852815f6d08eee4013d3a3b816b2" },
        { name: "AppImage", url: "#", size: "73.3 MB", sha256: "5b6860f1731332dfdf91913fe2fbbd1ac783c08a849a36ef9d1a66183a3153ae" }
      ]
    },
    imageUrl: "https://via.placeholder.com/400x200/667eea/ffffff?text=Templator+X",
    version: "v1.2.0",
    size: "45 MB"
  },
  {
    ...
    downloads: {
      windows: [
        { name: "Setup (EXE)", url: "https://github.com/xamp-fire/filecanvas/releases/download/v0.1.0/filecanvas_0.1.0_x64-setup.exe", size: "2.56 MB", sha256: "b4c69401c241bcacd8923b33e9036916b8eabc1ca64d15b42307efc1505d8aa7" },
        { name: "Installer (MSI)", url: "https://github.com/xamp-fire/filecanvas/releases/download/v0.1.0/filecanvas_0.1.0_x64_en-US.msi", size: "3.92 MB", sha256: "f8cf27babb00ef1a80b58d2cb26e76ea8d86e81e9baa3b86b7080cc40c946d1e" }
      ],
      mac: [
        { name: "Universal DMG", url: "https://github.com/xamp-fire/filecanvas/releases/download/v0.1.0/filecanvas_0.1.0_universal.dmg", size: "7.98 MB", sha256: "a0d40169bf3fe2a8148e441fa634395cc6f8ea636a93004271344f7e8f9660c5" },
        { name: "App Bundle (tar.gz)", url: "https://github.com/xamp-fire/filecanvas/releases/download/v0.1.0/filecanvas_universal.app.tar.gz", size: "7.91 MB", sha256: "ba9e282b004468a5521d1b2fc8af4e39156bdd6187f95cca62885b805cd7b0e0" }
      ],
      linux: [
        { name: "Debian/Ubuntu (.deb)", url: "https://github.com/xamp-fire/filecanvas/releases/download/v0.1.0/filecanvas_0.1.0_amd64.deb", size: "4.1 MB", sha256: "6fba19ac3fdb5ec2c0555146a5411badbb3c1fbfff4c586c5cc92098a39593c4" },
        { name: "Fedora/RHEL (.rpm)", url: "https://github.com/xamp-fire/filecanvas/releases/download/v0.1.0/filecanvas-0.1.0-1.x86_64.rpm", size: "4.1 MB", sha256: "7769fcfdf3cd7648a5051322abc911da7152852815f6d08eee4013d3a3b816b2" },
        { name: "AppImage", url: "https://github.com/xamp-fire/filecanvas/releases/download/v0.1.0/filecanvas_0.1.0_amd64.AppImage", size: "73.3 MB", sha256: "5b6860f1731332dfdf91913fe2fbbd1ac783c08a849a36ef9d1a66183a3153ae" }
      ]
    },
    imageUrl: "https://via.placeholder.com/400x200/764ba2/ffffff?text=FileCanvas",
    version: "v0.1.0",
  ...
  },
  {
    ...
    downloads: {
      windows: [
        { name: "Setup (EXE)", url: "#", size: "28 MB", sha256: "" }
      ],
      mac: [
        { name: "Universal DMG", url: "#", size: "32 MB", sha256: "" }
      ],
      linux: [
        { name: "AppImage", url: "#", size: "35 MB", sha256: "" }
      ]
    },
    imageUrl: "https://via.placeholder.com/400x200/4f46e5/ffffff?text=Branch",
    version: "v1.0.5",
    size: "28 MB"
  }
];
...
function showSnackbar(message, type = "info") {
  ...
  snackbar.className = `fixed bottom-4 right-4 px-6 py-3 rounded-lg shadow-lg text-white font-medium z-50 ${type === "success" ? "bg-green-600" : type === "error" ? "bg-red-600" : "bg-purple-600"} animate-fade-in`;
  snackbar.innerHTML = `
